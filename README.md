...
Ключ tasks отвечает за массив объектов, где каждый объект это последовательное действие, которое нужно выполнить. Каждое действие обладает описывается ключом job, который определяет тип действия
